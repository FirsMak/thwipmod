...
public class airfrictionController extends grappleController {
	...
	public airfrictionController(int arrowId, int entityId, World world, vec motion, int id, GrappleCustomization custom) {
		super(arrowId, entityId, world, motion, id, custom);
	}
	...
	public void updatePlayerPos() {
		...
		if (GrappleConfig.getconf().dont_override_movement_in_air && !entity.onGround && !was_sliding && !was_wallrunning) {
