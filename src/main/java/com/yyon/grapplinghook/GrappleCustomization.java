...
public class GrappleCustomization {
	public static final String[] booleanoptions = new String[] {"phaserope", "motor", "motorwhencrouching", "motorwhennotcrouching", "smartmotor", "enderstaff", "repel", "attract", "doublehook", "smartdoublemotor", "motordampener", "reelin", "pullbackwards", "oneropepull", "sticky", "detachonkeyrelease", "rocket", "tasmmode"};
	public static final String[] doubleoptions = new String[] {"maxlen", "hookgravity", "throwspeed", "motormaxspeed", "motoracceleration", "playermovementmult", "repelforce", "attractradius", "angle", "sneakingangle", "verticalthrowangle", "sneakingverticalthrowangle", "rocket_force", "rocket_active_time", "rocket_refuel_ratio", "rocket_vertical_angle", "sc"};
	public boolean tasmMode = false;
	public double sc = 3;
	// rope
	...
	public void setBoolean(String option, boolean bool) {
		...
		else if (option.equals("tasmmode")) {this.tasmMode = bool;}
	...
	public boolean getBoolean(String option) {
		...
		else if (option.equals("tasmmode")) {return this.tasmMode;}
	...
	public void setDouble(String option, double d) {
		...
		else if (option.equals("sc")) {this.sc = d;}
		...
		else if (option.equals("angle")) {this.angle = 0;}
	...
	public double getDouble(String option) {
		...
		else if (option.equals("sc")) {return sc;}
