...
@Config(modid="THWIP", name="grappling_hook", category="")
public class GrappleConfig {
	public static class Config {
		...
		public boolean default_detachonkeyrelease = true;
		// motor
		...
		// double hook
		public boolean default_doublehook = true;
		public boolean default_smartdoublemotor = true;
		public double default_angle = 0;
		...
		public int enable_detachonkeyrelease = 1;
		// motor
		...
		// double hook
		public int enable_doublehook = 1;
